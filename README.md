...
This repository contains crafting recipe images (under the [recipe_images](/recipe_images) folder) for all Minecraft java edition recipes as of 30/12/2025 (DD/MM/YYYY)    
